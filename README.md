...
```bash
git clone https://github.com/your-username/AI-Timetable.git
cd AI-Timetable
```
...
| venv activation blocked (Windows) | Run `Set-ExecutionPolicy RemoteSigned -Scope CurrentUser` in PowerShell |

---

## 🧬 How the Genetic Algorithm Works

1. **Initialization** — Generates a random population of timetables
2. **Fitness Evaluation** — Scores each timetable based on conflicts (room clashes, faculty clashes, etc.)
3. **Selection** — Picks the best-performing timetables
4. **Crossover** — Combines two timetables to produce a better offspring
5. **Mutation** — Randomly tweaks schedules to explore new solutions
6. **Repeat** — Runs for multiple generations until an optimal timetable is found
...
**Siri Naidu**
- GitHub: [@sirinaidu0223](https://github.com/sirinaidu0223)
